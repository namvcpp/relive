      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              "•  First, we will show you some main reasons that cause pains in your lower knees.",
              style: TextStyle(
                  color: myColors?.primaryColor,
                  fontWeight: FontWeight.w400,
                  fontSize: 14 * scale,
          ...
          Container(
            ...
            margin: EdgeInsets.only(left: 22 * scale),
            child: Text(
              "•  Second, we then elaborate on how your knees are affected by those activities.",
              style: TextStyle(
                  color: myColors?.primaryColor,
                  fontWeight: FontWeight.w400,
                  fontSize: 14 * scale,
          ...
          Container(
            ...
            margin: EdgeInsets.only(left: 22 * scale),
            child: Text(
              "•  Last, we show you the clear biological process for detailed view.",
              style: TextStyle(
                  color: myColors?.primaryColor,
                  fontWeight: FontWeight.w400,
                  fontSize: 14 * scale,
                ...
                Container(  
                  child: Center(
                    child: ElevatedButton(
                        style: ButtonStyle(
                          minimumSize:
                              MaterialStateProperty.all(Size(120 * scale, 85 * scale)),
                          maximumSize:
                              MaterialStateProperty.all(Size(170 * scale, 85 * scale)),
                          alignment: Alignment.center,
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const SquatInstructionScreen()),
                          );
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
