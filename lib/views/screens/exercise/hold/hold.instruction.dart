...
class HoldInstructionScreen extends StatelessWidget {
  const HoldInstructionScreen({Key? key}) : super(key: key);
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "•  Second, slowly raised your knee until your thigh is parallel to the floor and hold for 15 seconds.",
                    style: TextStyle(
                        color: myColors?.secondaryColor,
                        fontWeight: FontWeight.w400,
                        fontSize: 14,
