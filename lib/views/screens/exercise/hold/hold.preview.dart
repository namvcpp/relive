...
class HoldPreviewScreen extends StatefulWidget {
  const HoldPreviewScreen({Key? key}) : super(key: key);

  @override
  _HoldPreviewScreenState createState() => _HoldPreviewScreenState();
}

class _HoldPreviewScreenState extends State<HoldPreviewScreen> {
