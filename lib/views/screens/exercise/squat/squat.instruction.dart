...
class SquatInstructionScreen extends StatelessWidget {
  const SquatInstructionScreen({Key? key}) : super(key: key);
            ...
            child: Column(
              children: [
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "•  First, stand with your feet shoulder-width apart and your arms hanging at your sides with your back straight.",
                    style: TextStyle(
                        color: myColors?.secondaryColor,
                        fontWeight: FontWeight.w400,
                        fontSize: 14,
                ...
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "•  Second, slowly bend your knees and lower your hips down and back as if you were sitting down in a chair.",
                    style: TextStyle(
                        color: myColors?.secondaryColor,
                        fontWeight: FontWeight.w400,
                        fontSize: 14,
                ...
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "•  Next, lower until half your lowest points and hold for 3 seconds.",
                    style: TextStyle(
                        color: myColors?.secondaryColor,
                        fontWeight: FontWeight.w400,
                        fontSize: 14,
