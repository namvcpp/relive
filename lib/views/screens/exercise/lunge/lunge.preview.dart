...
class LungePreviewScreen extends StatefulWidget {
  const LungePreviewScreen({Key? key}) : super(key: key);

  @override
  _LungePreviewScreenState createState() => _LungePreviewScreenState();
}

class _LungePreviewScreenState extends State<LungePreviewScreen> {
