...
import 'package:fit_worker/views/screens/exercise/hold/hold_pose_detector.screen.dart';
import 'package:fit_worker/views/screens/exercise/lunge/lunge_pose_detector.screen.dart';
              ...
              children: [
                ...
                Center(
                  child: ElevatedButton(
                      style: ButtonStyle(
                          minimumSize:
                              MaterialStateProperty.all(Size(300 * scale, 54 * scale)),
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const SquatPoseDetectorView()),
                        ).then((value) {
