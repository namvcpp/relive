...
class CameraViewController: UIViewController {
  ...
  func setPoseDataStreamHandler(poseStreamHandler: PoseDataStreamHandler) {
    print("CameraViewController setPoseDataStreamHandler")
    ...
    override func viewDidAppear(_ animated: Bool) {
      ...
      print("Overlay bounds \(overlayView.bounds)")
      cameraFeedService.updateVideoPreviewLayer(toFrame: overlayView.bounds)
    }

    override func viewWillLayoutSubviews() {
      super.viewWillLayoutSubviews()
      print("CameraViewController viewWillLayoutSubviews")
      cameraFeedService.updateVideoPreviewLayer(toFrame: overlayView.bounds)
    }
  #endif
  ...
  @objc private func clearAndInitializePoseLandmarkerService() {
    ...
    print(
      "Model path: \(String(describing: InferenceConfigurationManager.sharedInstance.modelPath))")
