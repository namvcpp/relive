...
// distributed under the License istributed on an "AS IS" BASIS,
...
struct DefaultConstants {
  ...
  static var computeDelegate: MPPBaseOptionsDelegateType = MPPBaseOptionsDelegateType_Cpu
  static let modelPath: String? = Bundle.main.path(forResource: "pose_landmarker_full", ofType: "task")
}
